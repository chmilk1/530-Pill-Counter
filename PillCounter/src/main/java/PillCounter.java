...
public class PillCounter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Button blueButton = new Button("BlueButton", 5, 20, 10, 9, console, pi4j);
        Button greenButton = new Button("GreenButton", 6, 24, 17, 27, console, pi4j);
        Button yellowButton = new Button("YellowButton", 23, 15, 14, 4, console, pi4j);
        Button redButton = new Button("RedButton", 16, 8, 25, 11, console, pi4j);
        ...
        while (true) {
            blueButton.checkState();
            greenButton.checkState();
